...
func (r FutureGetRawTransactionResult) Receive() (*hcashutil.Tx, error) {
	...
	return hcashutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := hcashjson.NewGetRawTransactionCmd(hash, hcashjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*hcashutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*hcashjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult hcashjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := hcashjson.NewGetRawTransactionCmd(hash, hcashjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*hcashjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*hcashjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := hcashjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*hcashjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []hcashjson.TransactionInput,
	amounts map[hcashutil.Address]hcashutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCoin()
	}
	cmd := hcashjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []hcashjson.TransactionInput,
	amounts map[hcashutil.Address]hcashutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	...
	CommitAmt  hcashutil.Amount
	ChangeAddr hcashutil.Address
	ChangeAmt  hcashutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []hcashjson.SStxInput,
	amount map[hcashutil.Address]hcashutil.Amount,
	...
	cmd := hcashjson.NewCreateRawSStxCmd(inputs,
		convertedAmt,
		convertedCouts)
...
// and sending to the provided addresses.
func (c *Client) CreateRawSStx(inputs []hcashjson.SStxInput,
	amount map[hcashutil.Address]hcashutil.Amount,
...
func (c *Client) CreateRawSSGenTxAsync(inputs []hcashjson.TransactionInput,
	votebits uint16) FutureCreateRawSSGenTxResult {

	cmd := hcashjson.NewCreateRawSSGenTxCmd(inputs, votebits)
	return c.sendCmd(cmd)
}

// CreateRawSSGenTx returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawSSGenTx(inputs []hcashjson.TransactionInput,
...
func (c *Client) CreateRawSSRtxAsync(inputs []hcashjson.TransactionInput, fee hcashutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
	cmd := hcashjson.NewCreateRawSSRtxCmd(inputs, &feeF64)
	return c.sendCmd(cmd)
}

// CreateRawSSRtx returns a new SSR transactionm (revoking an sstx).
func (c *Client) CreateRawSSRtx(inputs []hcashjson.TransactionInput, fee hcashutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := hcashjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult hcashjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := hcashjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []hcashjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := hcashjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []hcashjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := hcashjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []hcashjson.RawTxInput, privKeysWIF []string,
	...
	cmd := hcashjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		hcashjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawSSGenTxAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := hcashjson.NewSignRawTransactionCmd(txHex, &[]hcashjson.RawTxInput{},
		nil, hcashjson.String("ssgen"))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address hcashutil.Address, skip,
	count int, reverse bool,
	filterAddrs []string) FutureSearchRawTransactionsResult {

	addr := address.EncodeAddress()
	verbose := hcashjson.Int(0)
	cmd := hcashjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address hcashutil.Address, skip, count int,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*hcashjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*hcashjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address hcashutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address hcashutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs []string) ([]*hcashjson.SearchRawTransactionsResult, error) {
