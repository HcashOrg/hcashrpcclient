...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := hcashjson.NewGenerateCmd(numBlocks)
...
func (c *Client) GetGenerateAsync() FutureGetGenerateResult {
	cmd := hcashjson.NewGetGenerateCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := hcashjson.NewSetGenerateCmd(enable, &numCPUs)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := hcashjson.NewGetHashesPerSecCmd()
	return c.sendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*hcashjson.GetMiningInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult hcashjson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := hcashjson.NewGetMiningInfoCmd()
	return c.sendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*hcashjson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := hcashjson.NewGetNetworkHashPSCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := hcashjson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := hcashjson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.sendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*hcashjson.GetWorkResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result hcashjson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWorkAsync() FutureGetWork {
	cmd := hcashjson.NewGetWorkCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetWork() (*hcashjson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := hcashjson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockTemplate) Receive() (*hcashjson.GetBlockTemplateResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result.
	var gbt hcashjson.GetBlockTemplateResult
...
func (c *Client) GetBlockTemplateAsync(req *hcashjson.TemplateRequest) FutureGetBlockTemplate {
	cmd := hcashjson.NewGetBlockTemplateCmd(req)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockTemplate(req *hcashjson.TemplateRequest) (*hcashjson.GetBlockTemplateResult, error) {
...
func (c *Client) SubmitBlockAsync(block *hcashutil.Block, options *hcashjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := hcashjson.NewSubmitBlockCmd(blockHex, options)
	return c.sendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the hypercash network.
func (c *Client) SubmitBlock(block *hcashutil.Block, options *hcashjson.SubmitBlockOptions) error {
