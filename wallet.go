...
func (r FutureGetTransactionResult) Receive() (*hcashjson.GetTransactionResult, error) {
	...
	var getTx hcashjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := hcashjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*hcashjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]hcashjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := hcashjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]hcashjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := hcashjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]hcashjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := hcashjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (r FutureListUnspentResult) Receive() ([]hcashjson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []hcashjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := hcashjson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := hcashjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := hcashjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []hcashutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := hcashjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]hcashjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]hcashjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]hcashjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []hcashutil.Address) ([]hcashjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*hcashjson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult hcashjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = hcashjson.String(blockHash.String())
	}

	cmd := hcashjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*hcashjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := hcashjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*hcashjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]hcashjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = hcashjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
			Tree: op.Tree,
		}
	}
	cmd := hcashjson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []hcashjson.TransactionInput
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // Hypercash TODO
	}
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := hcashjson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address hcashutil.Address, amount hcashutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[hcashutil.Address]hcashutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[hcashutil.Address]hcashutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) PurchaseTicketAsync(fromAccount string,
	spendLimit hcashutil.Amount, minConf *int, ticketAddress hcashutil.Address,
	numTickets *int, poolAddress hcashutil.Address, poolFees *hcashutil.Amount,
	...
	cmd := hcashjson.NewPurchaseTicketCmd(fromAccount, spendLimit.ToCoin(),
...
func (c *Client) SendToSStxAsync(fromAccount string,
	...
	convertedCouts := make([]hcashjson.SStxCommitOut, len(couts))
	...
	cmd := hcashjson.NewSendToSStxCmd(fromAccount, convertedAmounts,
...
func (c *Client) SendToSSGenAsync(fromAccount string,
	...
	cmd := hcashjson.NewSendToSSGenCmd(fromAccount, ticketHashString,
...
func (c *Client) SendToSSRtxAsync(fromAccount string,
	...
	cmd := hcashjson.NewSendToSSRtxCmd(fromAccount, ticketHashString, nil)
...
func (c *Client) SendToSSRtxCommentAsync(fromAccount string,
	...
	cmd := hcashjson.NewSendToSSRtxCmd(fromAccount, ticketHashString, &comment)
...
func (r FutureAddMultisigAddressResult) Receive() (hcashutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hcashutil.DecodeAddress(addr)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []hcashutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := hcashjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []hcashutil.Address, account string) (hcashutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*hcashjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes hcashjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []hcashutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := hcashjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []hcashutil.Address) (*hcashjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (hcashutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := hcashjson.NewGetNewAddressCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNewAddressGapPolicyAsync(account string, gapPolicy GapPolicy) FutureGetNewAddressResult {
	cmd := hcashjson.NewGetNewAddressCmd(&account, (*string)(&gapPolicy))
	return c.sendCmd(cmd)
}

// GetNewAddress returns a new address.
func (c *Client) GetNewAddress(account string) (hcashutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (hcashutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (hcashutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := hcashjson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawChangeAddress(account string) (hcashutil.Address, error) {
...
// Hypercash address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (hcashutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := hcashjson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}

// GetAccountAddress returns the current Hypercash address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (hcashutil.Address, error) {
...
func (c *Client) GetAccountAsync(address hcashutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address hcashutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]hcashutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]hcashutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := hcashutil.DecodeAddress(addrStr)
		if err != nil {
			return nil, err
		}
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := hcashjson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}

// GetAddressesByAccount returns the list of addresses associated with the
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]hcashutil.Address, error) {
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := hcashjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
// about the given hypercash address.
func (r FutureValidateAddressResult) Receive() (*hcashjson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult hcashjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address hcashutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given hypercash address.
func (c *Client) ValidateAddress(address hcashutil.Address) (*hcashjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := hcashjson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := hcashjson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]hcashutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]hcashutil.Amount)
	for k, v := range accounts {
		amount, err := hcashutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := hcashjson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]hcashutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := hcashjson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]hcashutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (*hcashjson.GetBalanceResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var balance hcashjson.GetBalanceResult
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := hcashjson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (*hcashjson.GetBalanceResult, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := hcashjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (*hcashjson.GetBalanceResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (hcashutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := hcashutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := hcashjson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (hcashutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := hcashjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (hcashutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (hcashutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := hcashjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (hcashutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (hcashutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address hcashutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address hcashutil.Address) (hcashutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address hcashutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address hcashutil.Address, minConfirms int) (hcashutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]hcashjson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []hcashjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := hcashjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]hcashjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := hcashjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]hcashjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := hcashjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]hcashjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]hcashjson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []hcashjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := hcashjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]hcashjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := hcashjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]hcashjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := hcashjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]hcashjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletLockAsync() FutureWalletLockResult {
	cmd := hcashjson.NewWalletLockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := hcashjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := hcashjson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address hcashutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address hcashutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address hcashutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address hcashutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*hcashutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hcashutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address hcashutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := hcashjson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address hcashutil.Address) (*hcashutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := hcashjson.NewImportAddressCmd(address, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, rescan bool) FutureImportAddressResult {
	cmd := hcashjson.NewImportAddressCmd(address, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *hcashutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hcashjson.NewImportPrivKeyCmd(wif, nil, nil, nil)
	return c.sendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *hcashutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *hcashutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hcashjson.NewImportPrivKeyCmd(wif, &label, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *hcashutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *hcashutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hcashjson.NewImportPrivKeyCmd(wif, &label, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *hcashutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *hcashutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hcashjson.NewImportPrivKeyCmd(wif, &label, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *hcashutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := hcashjson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := hcashjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptAsync(script []byte) FutureImportScriptResult {
	...
	cmd := hcashjson.NewImportScriptCmd(scriptStr, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanAsync(script []byte, rescan bool) FutureImportScriptResult {
	...
	cmd := hcashjson.NewImportScriptCmd(scriptStr, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanFromAsync(script []byte, rescan bool, scanFrom int) FutureImportScriptResult {
	...
	cmd := hcashjson.NewImportScriptCmd(scriptStr, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountAddressIndexAsync(account string, branch uint32) FutureAccountAddressIndexResult {
	cmd := hcashjson.NewAccountAddressIndexCmd(account, int(branch))
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountSyncAddressIndexAsync(account string, branch uint32, index int) FutureAccountSyncAddressIndexResult {
	cmd := hcashjson.NewAccountSyncAddressIndexCmd(account, int(branch), index)
	return c.sendCmd(cmd)
}
...
func (c *Client) RevokeTicketsAsync() FutureRevokeTicketsResult {
	cmd := hcashjson.NewRevokeTicketsCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicketAsync(rawHex string) FutureAddTicketResult {
	cmd := hcashjson.NewAddTicketCmd(rawHex)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicket(ticket *hcashutil.Tx) error {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGenerateVoteResult) Receive() (*hcashjson.GenerateVoteResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hcashjson.GenerateVoteResult
...
func (c *Client) GenerateVoteAsync(blockHash *chainhash.Hash, height int64, keyHeight int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) FutureGenerateVoteResult {
	cmd := hcashjson.NewGenerateVoteCmd(blockHash.String(), height, keyHeight, sstxHash.String(), voteBits, voteBitsExt)
	return c.sendCmd(cmd)
}

// GenerateVote returns hex of an SSGen.
func (c *Client) GenerateVote(blockHash *chainhash.Hash, height int64, keyHeight int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) (*hcashjson.GenerateVoteResult, error) {
	return c.GenerateVoteAsync(blockHash, height, keyHeight, sstxHash, voteBits, voteBitsExt).Receive()
}

// NOTE: While getinfo is implemented here (in wallet.go), a hcashd chain server
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGetInfoResult) Receive() (*hcashjson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes hcashjson.InfoWalletResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetInfo() (*hcashjson.InfoWalletResult, error) {
...
func (r FutureGetStakeInfoResult) Receive() (*hcashjson.GetStakeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hcashjson.GetStakeInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeInfoAsync() FutureGetStakeInfoResult {
	cmd := hcashjson.NewGetStakeInfoCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetStakeInfo() (*hcashjson.GetStakeInfoResult, error) {
...
func (r FutureGetTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	var tixRes hcashjson.GetTicketsResult
...
func (c *Client) GetTicketsAsync(includeImmature bool) FutureGetTicketsResult {
	cmd := hcashjson.NewGetTicketsCmd(includeImmature)
	return c.sendCmd(cmd)
}
...
func (r FutureListScriptsResult) Receive() ([][]byte, error) {
	...
	var resScr hcashjson.ListScriptsResult
...
func (c *Client) ListScriptsAsync() FutureListScriptsResult {
	cmd := hcashjson.NewListScriptsCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTicketFeeAsync(fee hcashutil.Amount) FutureSetTicketFeeResult {
	cmd := hcashjson.NewSetTicketFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTicketFee sets the ticket fee per KB amount.
func (c *Client) SetTicketFee(fee hcashutil.Amount) error {
...
func (c *Client) SetTxFeeAsync(fee hcashutil.Amount) FutureSetTxFeeResult {
	cmd := hcashjson.NewSetTxFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTxFee sets the transaction fee per KB amount.
func (c *Client) SetTxFee(fee hcashutil.Amount) error {
...
// Receive waits for the response promised by the future.
func (r FutureGetVoteChoicesResult) Receive() (*hcashjson.GetVoteChoicesResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var choicesRes hcashjson.GetVoteChoicesResult
...
func (c *Client) SetVoteChoiceAsync(agendaID, choiceID string) FutureSetVoteChoiceResult {
	cmd := hcashjson.NewSetVoteChoiceCmd(agendaID, choiceID)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureStakePoolUserInfoResult) Receive() (*hcashjson.StakePoolUserInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hcashjson.StakePoolUserInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) StakePoolUserInfoAsync(addr hcashutil.Address) FutureStakePoolUserInfoResult {
	cmd := hcashjson.NewStakePoolUserInfoCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}

// StakePoolUserInfo returns a list of tickets and information about them
// that are paying to the passed address.
func (c *Client) StakePoolUserInfo(addr hcashutil.Address) (*hcashjson.StakePoolUserInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureTicketsForAddressResult) Receive() (*hcashjson.TicketsForAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hcashjson.TicketsForAddressResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) TicketsForAddressAsync(addr hcashutil.Address) FutureTicketsForAddressResult {
	cmd := hcashjson.NewTicketsForAddressCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}
...
// owned by the wallet.
func (c *Client) TicketsForAddress(addr hcashutil.Address) (*hcashjson.TicketsForAddressResult, error) {
...
// Receive waits for the response promised by the future and returns the stake
// info provided by the server.
func (r FutureWalletInfoResult) Receive() (*hcashjson.WalletInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hcashjson.WalletInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletInfoAsync() FutureWalletInfoResult {
	cmd := hcashjson.NewWalletInfoCmd()
	return c.sendCmd(cmd)
}

// WalletInfo returns wallet global state info for a given wallet.
func (c *Client) WalletInfo() (*hcashjson.WalletInfoResult, error) {
	return c.WalletInfoAsync().Receive()
}

// TODO(davec): Implement
// backupwallet (NYI in hcashwallet)
// encryptwallet (Won't be supported by hcashwallet since it's always encrypted)
// getwalletinfo (NYI in hcashwallet or hcashjson)
// listaddressgroupings (NYI in hcashwallet)
// listreceivedbyaccount (NYI in hcashwallet)

// DUMP
// importwallet (NYI in hcashwallet)
// dumpwallet (NYI in hcashwallet)
