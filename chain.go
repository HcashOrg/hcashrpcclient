...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := hcashjson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := hcashjson.NewGetBlockCmd(hash, hcashjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*hcashjson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult hcashjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash, verboseTx bool) FutureGetBlockVerboseResult {
	...
	cmd := hcashjson.NewGetBlockCmd(hash, hcashjson.Bool(true), &verboseTx)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash, verboseTx bool) (*hcashjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := hcashjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := hcashjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := hcashjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(hash *chainhash.Hash) FutureGetBlockHeaderResult {
	cmd := hcashjson.NewGetBlockHeaderCmd(hash.String(), hcashjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*hcashjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var bh hcashjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(hash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	cmd := hcashjson.NewGetBlockHeaderCmd(hash.String(), hcashjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(hash *chainhash.Hash) (*hcashjson.GetBlockHeaderVerboseResult, error) {
...
func (c *Client) GetRawMempoolAsync(txType hcashjson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolResult {
	cmd := hcashjson.NewGetRawMempoolCmd(hcashjson.Bool(false),
		hcashjson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempool(txType hcashjson.GetRawMempoolTxTypeCmd) ([]*chainhash.Hash, error) {
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]hcashjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]hcashjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync(txType hcashjson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolVerboseResult {
	cmd := hcashjson.NewGetRawMempoolCmd(hcashjson.Bool(true),
		hcashjson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose(txType hcashjson.GetRawMempoolTxTypeCmd) (map[string]hcashjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := hcashjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int64) FutureVerifyChainResult {
	cmd := hcashjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int64) FutureVerifyChainResult {
	cmd := hcashjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*hcashjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *hcashjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := hcashjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*hcashjson.GetTxOutResult, error) {
...
func (r FutureRescanResult) Receive() (*hcashjson.RescanResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanResult *hcashjson.RescanResult
...
func (c *Client) RescanAsync(blockHashes []chainhash.Hash) FutureRescanResult {
	...
	cmd := hcashjson.NewRescanCmd(hex.EncodeToString(concatenatedBlockHashes))
	return c.sendCmd(cmd)
}
...
func (c *Client) Rescan(blockHashes []chainhash.Hash) (*hcashjson.RescanResult, error) {
